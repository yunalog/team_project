...
const NORMAL_MONSTER_SPLASH_DAMAGE_RATIO = 0.45;
const UNIT_HP_RECOVERY_RATE = 1.1;
const CRITICAL_CHANCE = 0.16;
const CRITICAL_MULTIPLIER = 1.85;
const EQUIPMENT_DRAW_COST = 10;
const EQUIPMENT_DISCARD_REFUND_MIN = 4;
const EQUIPMENT_DISCARD_REFUND_MAX = 5;
...
const RECRUIT_LEVEL_UP_COST_RATE = 0.42;
const PLAYER_UPGRADE_COST_RATE = 0.6;
const IDEA_GAIN_BONUS_RATE = 0.15;
const PLAYER_UPGRADE_STAT_RATE = 0.4;
const PLAYER_EQUIPMENT_STAT_RATE = 0.25;
...
const companyLevels = [
  {
    name: "1인 창업실",
    minXp: 0,
    desc: "작은 책상에서 첫 프로젝트를 시작했습니다.",
    benefit: "창문과 업무 공간 확장",
    brandBonus: { goldGain: 0.05, ideaGain: 0 },
  },
  {
    name: "작은 작업실",
    minXp: 24,
    desc: "동료를 맞이할 작은 작업실이 생겼습니다.",
    benefit: "두 번째 업무 공간 개방",
    brandBonus: { goldGain: 0.05, ideaGain: 0.05 },
  },
  {
    name: "프로젝트 팀",
    minXp: 60,
    desc: "각자의 역할을 갖춘 팀이 자리를 잡았습니다.",
    benefit: "사무실 간판과 휴게 공간",
    brandBonus: { goldGain: 0.1, ideaGain: 0.05 },
  },
  {
    name: "초기 스타트업",
    minXp: 114,
    desc: "정식 회사의 모습을 갖추기 시작합니다.",
    benefit: "2층 오피스로 이전",
    brandBonus: { goldGain: 0.1, ideaGain: 0.1 },
  },
  {
    name: "성장 스타트업",
    minXp: 186,
    desc: "입소문을 타고 더 큰 의뢰가 들어옵니다.",
    benefit: "회의실과 조경 추가",
    brandBonus: { goldGain: 0.15, ideaGain: 0.1 },
  },
  {
    name: "전문 스튜디오",
    minXp: 282,
    desc: "전문 제작 조직으로 업계에 이름을 알립니다.",
    benefit: "전문 부서층 개방",
    brandBonus: { goldGain: 0.15, ideaGain: 0.15 },
  },
  {
    name: "소형 기업",
    minXp: 408,
    desc: "안정적인 조직과 여러 프로젝트를 운영합니다.",
    benefit: "독립 사옥 착공",
    brandBonus: { goldGain: 0.2, ideaGain: 0.15 },
  },
  {
    name: "확장 오피스",
    minXp: 570,
    desc: "새 사옥에서 더 많은 인재와 함께합니다.",
    benefit: "대형 로비와 편의 시설",
    brandBonus: { goldGain: 0.2, ideaGain: 0.2 },
  },
  {
    name: "중견 기업",
    minXp: 774,
    desc: "시장을 이끄는 탄탄한 회사로 성장했습니다.",
    benefit: "도심 타워로 확장",
    brandBonus: { goldGain: 0.25, ideaGain: 0.2 },
  },
  {
    name: "멀티 스튜디오",
    minXp: 1032,
    desc: "여러 제작팀이 동시에 성과를 만들어냅니다.",
    benefit: "브랜드 네온 사인",
    brandBonus: { goldGain: 0.25, ideaGain: 0.25 },
  },
  {
    name: "대형 기업",
    minXp: 1350,
    desc: "도시를 대표하는 대형 스튜디오가 되었습니다.",
    benefit: "글로벌 캠퍼스 개방",
    brandBonus: { goldGain: 0.3, ideaGain: 0.25 },
  },
  {
    name: "글로벌 기업",
    minXp: 1740,
    desc: "전 세계가 주목하는 글로벌 기업입니다.",
    benefit: "최고 단계 달성",
    brandBonus: { goldGain: 0.3, ideaGain: 0.3 },
  },
];
...
const defaultState = {
  ...
  recruitCompanyTutorialCompleted: false,
...
let isCloudSaveBlocked = false;
let cloudSaveBlockedReason = "";
